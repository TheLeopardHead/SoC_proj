...
module e203_subsys_perips(
  ...
  output  [32-1:0]           cnn_icb_cmd_addr,
  output                     cnn_icb_cmd_read,
  output  [32-1:0]           cnn_icb_cmd_wdata,
  output  [4-1:0]            cnn_icb_cmd_wmask,

  input                      cnn_icb_rsp_valid,
  output                     cnn_icb_rsp_ready,
  input [32-1:0]             cnn_icb_rsp_rdata,
...
input 			  adder_cfg_icb_rsp_err,
  ...
  wire [32-1:0]            cfg_icb_cmd_addr; 
  wire                     cfg_icb_cmd_read; 
  wire [32-1:0]            cfg_icb_cmd_wdata;
  wire [4 -1:0]            cfg_icb_cmd_wmask;
  
  wire                     cfg_icb_rsp_valid;
  wire                     cfg_icb_rsp_ready;
  wire [32-1:0]            cfg_icb_rsp_rdata;
  ...
  //  * GPIOB      
   ...
   //  *      
    ...
    .o15_icb_cmd_valid  (cfg_icb_cmd_valid),
    .o15_icb_cmd_ready  (cfg_icb_cmd_ready),
    .o15_icb_cmd_addr   (cfg_icb_cmd_addr),
    .o15_icb_cmd_read   (cfg_icb_cmd_read),
    .o15_icb_cmd_wdata  (cfg_icb_cmd_wdata),
    .o15_icb_cmd_wmask  (cfg_icb_cmd_wmask),
    .o15_icb_cmd_lock   (),
    .o15_icb_cmd_excl   (),
    .o15_icb_cmd_size   (),
    .o15_icb_cmd_burst  (),
    ...
    .o15_icb_rsp_valid  (cfg_icb_rsp_valid),
    .o15_icb_rsp_ready  (cfg_icb_rsp_ready),
    .o15_icb_rsp_err    (1'b0),
    .o15_icb_rsp_excl_ok(1'b0),
    .o15_icb_rsp_rdata  (cfg_icb_rsp_rdata),
...
//Conv u_conv (
//    .s_axi_AXILiteS_ARVALID   (expl_axi_arvalid),
//    .s_axi_AXILiteS_ARREADY   (expl_axi_arready),
//    .s_axi_AXILiteS_ARADDR    (expl_axi_araddr ),
//    //.axi_arcache   (expl_axi_arcache),
//    //.axi_arprot    (expl_axi_arprot ),
//    //.axi_arlock    (expl_axi_arlock ),
//    //.axi_arburst   (expl_axi_arburst),
...
//    //.axi_arsize    (expl_axi_arsize ),
//     
//    .s_axi_AXILiteS_AWVALID   (expl_axi_awvalid),
//    .s_axi_AXILiteS_AWREADY   (expl_axi_awready),
//    .s_axi_AXILiteS_AWADDR    (expl_axi_awaddr ),
//    //.axi_awcache   (expl_axi_awcache),
//    //.axi_awprot    (expl_axi_awprot ),
//    //.axi_awlock    (expl_axi_awlock ),
//    //.axi_awburst   (expl_axi_awburst),
...
//    //.axi_awsize    (expl_axi_awsize ),
//    
//    .s_axi_AXILiteS_RVALID    (expl_axi_rvalid ),
//    .s_axi_AXILiteS_RREADY    (expl_axi_rready ),
//    .s_axi_AXILiteS_RDATA     (expl_axi_rdata  ),
//    .s_axi_AXILiteS_RRESP     (expl_axi_rresp  ),
//    //.axi_rlast     (expl_axi_rlast  ),
//   
//    .s_axi_AXILiteS_WVALID    (expl_axi_wvalid ),
//    .s_axi_AXILiteS_WREADY    (expl_axi_wready ),
//    .s_axi_AXILiteS_WDATA     (expl_axi_wdata  ),
//    .s_axi_AXILiteS_WSTRB     (expl_axi_wstrb  ),
//    //.axi_wlast     (expl_axi_wlast  ),
//  
//    .s_axi_AXILiteS_BVALID    (expl_axi_bvalid ),
//    .s_axi_AXILiteS_BREADY    (expl_axi_bready ),
//    .s_axi_AXILiteS_BRESP     (expl_axi_bresp  ),
//
//    .ap_clk           (clk  ),
//    .ap_rst_n         (rst_n) 
//  );
