...
module e203_subsys_mems(
  ...
  input                          cnn_icb_cmd_valid,
  output                         cnn_icb_cmd_ready,
  input  [`E203_ADDR_SIZE-1:0]   cnn_icb_cmd_addr, 
  input                          cnn_icb_cmd_read, 
  input  [`E203_XLEN-1:0]        cnn_icb_cmd_wdata,
  input  [`E203_XLEN/8-1:0]      cnn_icb_cmd_wmask,
  //
  output                         cnn_icb_rsp_valid,
  input                          cnn_icb_rsp_ready,
  output [`E203_XLEN-1:0]        cnn_icb_rsp_rdata,
...
//the cpu icb has higner priority
  ...
  assign {cnn_icb_cmd_ready,
	  mem_icb_cmd_ready
	 } = arbt_bus_icb_cmd_ready;

  assign {cnn_icb_rsp_valid,
	  mem_icb_rsp_valid
	 } = arbt_bus_icb_rsp_valid;

 assign 
	  mem_icb_rsp_err
	  = arbt_bus_icb_rsp_err[0];

  assign {cnn_icb_rsp_rdata,
	  mem_icb_rsp_rdata
...
//the arbt module
  ...
  wire                     sram_wr_icb_cmd_valid;
  wire                     sram_wr_icb_cmd_ready;
  wire [32-1:0]            sram_wr_icb_cmd_addr; 
  wire                     sram_wr_icb_cmd_read; 
  wire [32-1:0]            sram_wr_icb_cmd_wdata;
  wire [4 -1:0]            sram_wr_icb_cmd_wmask;
  
  wire                     sram_wr_icb_rsp_valid;
  wire                     sram_wr_icb_rsp_ready;
  wire [32-1:0]            sram_wr_icb_rsp_rdata;
  wire                     sram_wr_icb_rsp_err;
 ...
 localparam MROM_DP = 1024;
  ...
  //  * sram_weight :0x0000_2000 --0x0000 2fff
  //  * sram_image: 0x4000_0000 --0x4000 ffff
  //  * sram_wr: 0x6000_0000 --0x6000 ffff
  ...
  //sram_image: 0x4000_0000 --0x4000 0fff

  .O6_BASE_ADDR       (32'h4000_0000),       
  .O6_BASE_REGION_LSB (12),
  
  // sram_wr: 0x6000_0000 --0x6000 0fff
  ...
  //  * SysMem
   ...
   //  * sram weight 
    ...
    .o7_icb_cmd_valid  (sram_wr_icb_cmd_valid),
    .o7_icb_cmd_ready  (sram_wr_icb_cmd_ready),
    .o7_icb_cmd_addr   (sram_wr_icb_cmd_addr),
    .o7_icb_cmd_read   (sram_wr_icb_cmd_read),
    .o7_icb_cmd_wdata  (sram_wr_icb_cmd_wdata),
    .o7_icb_cmd_wmask  (sram_wr_icb_cmd_wmask),
    .o7_icb_cmd_lock   (),
    .o7_icb_cmd_excl   (),
    .o7_icb_cmd_size   (),
    .o7_icb_cmd_burst  (),
    ...
    .o7_icb_rsp_valid  (sram_wr_icb_rsp_valid),
    .o7_icb_rsp_ready  (sram_wr_icb_rsp_ready),
    .o7_icb_rsp_err    (sram_wr_icb_rsp_err),
    .o7_icb_rsp_excl_ok(1'b0  ),
    .o7_icb_rsp_rdata  (sram_wr_icb_rsp_rdata),
