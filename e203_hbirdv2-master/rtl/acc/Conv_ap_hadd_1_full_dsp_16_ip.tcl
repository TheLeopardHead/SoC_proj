...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name Conv_ap_hadd_1_full_dsp_16
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Half \
                          ...
                          CONFIG.component_name Conv_ap_hadd_1_full_dsp_16 \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips Conv_ap_hadd_1_full_dsp_16] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files Conv_ap_hadd_1_full_dsp_16.xci]
generate_target {synthesis simulation} [get_files Conv_ap_hadd_1_full_dsp_16.xci]
